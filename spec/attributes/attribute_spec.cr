...
require "../spec_helper"
# TODO: Figure out alternative for ostrcut use here
# require "ostruct"
...
module Arel
  module Attributes
    ...
    #   )
    # end
    private class QuotedRange
      def initialize(
        @begin : Nodes::Quoted, @end : Nodes::Quoted, @exclude
      ); end 
      getter :begin, :end
      def exclude_end?; @exclude end
    end
    ...
    class FakeCaster
      def self.type_cast_for_database(attr_name, value)
        if attr_name == "id"
          value.to_i
        else
          value
    ...
    describe "attribute" do
      ...
      describe "with a range" do
        ...
        it "can be constructed with an infinite range" do
          ...
          node.must_equal Nodes::NotIn.new(attribute, [] of U) # TODO: Determine Types!
        end
      ...
      describe "with a range" do
        ...
        it "can be constructed with an infinite range" do
          ...
          node.must_equal Nodes::In.new(attribute, [] of U) # TODO: Determine Types!
        end
