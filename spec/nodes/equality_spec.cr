...
module Arel
  module Nodes
    module FakeRecordExtendModule
      property :quote_count
      private def quote(*args) @quote_count += 1; super; end
      private def quote_column_name(*args) @quote_count += 1; super; end
      private def quote_table_name(*args) @quote_count += 1; super; end
    end
      ...
      describe "backwards compat" do
        ...
        describe "to_sql" do
          it "takes an engine" do
            ...
            engine.connection.extend FakeRecordExtendModule
