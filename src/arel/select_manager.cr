...
module Arel
  class SelectManager < Arel::TreeManager
    ...
    # TODO: Search for uses of keyword "as" and replace
    def _as(other)
    ...
    class Row
      property :data
      include Enumerable(Nil) # TODO: Replacement for Struct inheritance... check if needed
      def id
        data["id"]
      end
